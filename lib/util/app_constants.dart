...
class AppConstants {
  static const String APP_NAME = 'Chhotulal';
  static const int APP_VERSION = 1;
  static const int SLOT_IN_MINUTE = 30;
  static const int DIGITS_AFTER_POINT = 2;

  static const String BASE_URL = 'https://home-office.chhotulal.in';
  ...
  static const String LOCALIZATION_KEY = 'X-localization';//FIND ENGLISH.JSON FILE OR ARBIC.JSON wait//send apk now ok

  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.english, languageName: 'English', countryCode: 'US', languageCode: 'en'),
    LanguageModel(imageUrl: Images.arabic, languageName: 'Hindi', countryCode: 'iN', languageCode: 'ar'),
  ];
}
